void main_setup() { //Case 2: Cone JOHNS; required extensions in defines.hpp: FP16S, EQUILIBRIUM_BOUNDARIES, SUBGRID, INTERACTIVE_GRAPHICS or GRAPHICS
	...
	Mesh* mesh = read_stl(get_exe_path()+"/stl/SimpleCone.stl", lbm.size(), lbm.center(), rotation, lbm_length);
